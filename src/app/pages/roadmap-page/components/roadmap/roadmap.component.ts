...
export class RoadmapComponent implements OnInit {
  ...
  getPlannedSuggestions(): any[] {
    return this.data.productRequests.filter((request: any) => request.status === 'planned');
  }
  getInProgressSuggestions(): any[] {
    return this.data.productRequests.filter((request: any) => request.status === 'in-progress');
  }
  getLiveSuggestions(): any[] {
    return this.data.productRequests.filter((request: any) => request.status === 'live');
  }

  getPlannedSuggestionsCount(): number {
    return this.data.productRequests.filter((request: any) => request.status === 'planned').length;
  }
  getInProgressSuggestionsCount(): number {
    return this.data.productRequests.filter((request: any) => request.status === 'in-progress').length;
  }
  getLiveSuggestionsCount(): number {
    return this.data.productRequests.filter((request: any) => request.status === 'live').length;
  }
}
