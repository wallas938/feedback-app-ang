...
export class RoadmapMobileComponent implements OnInit {
  ...
  displayPlanned(currentTab: string) {
    this.toDisplay = this.data.productRequests.filter((request: any) => request.status === 'planned');
  ...
  displayInProgress(currentTab: string) {
    this.toDisplay = this.data.productRequests.filter((request: any) => request.status === 'in-progress');
  ...
  displayLive(currentTab: string) {
    this.toDisplay = this.data.productRequests.filter((request: any) => request.status === 'live');
